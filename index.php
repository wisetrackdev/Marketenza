                ...
                <div class="d-flex flex-column gspace-2">
                    ...
                    <div class="banner-heading">
                        <div class="banner-video-content order-lg-1 order-2 animation-box anim-normal anim-delay-sm"
                            ...
                            <div
                                class="d-flex flex-column flex-lg-row text-lg-start text-center align-items-center gspace-5">
                ...
                <div class="expertise-img-layout">
                    <div class="image-container expertise-img">
                        <img src="image/working-job-career-casual-showing-SJZWF3N-1024x737.jpg" alt="Expertise Image"
                            class="img-fluid animation-box anim-normal anim-delay-sm" data-animation="fade-up">
            ...
            <div class="d-flex flex-column justify-content-center text-center gspace-5">
                ...
                <div class="card-service-wrapper">
                    <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 grid-spacer-2">
                        ...
                        <div class="col">
                            <article class="card card-service animation-box anim-slow anim-delay-md"
                                data-animation="fade-right">
                                <div class="service-card-header">
                                    <div class="service-icon-box">
                                        <i class="fa-solid fa-laptop-code"></i>
                                    </div>
                                    <span class="service-tag">Custom Code</span>
                                </div>
                                <div class="service-card-body">
                                    <h3 class="heading-sm">Website Development</h3>
                                    <p>Custom, mobile-responsive web applications built for blazing-fast loading speeds,
                                        SEO performance, and maximum lead generation.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Next.js & Custom PHP / React</li>
                                        <li><i class="fa-solid fa-circle-check"></i> Mobile-First UX/UI Design</li>
                                        <li><i class="fa-solid fa-circle-check"></i> Ultra-Fast Speed Optimization</li>
                                    </ul>
                                </div>
                                <a href="website-development.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                        ...
                        <!-- 5. App Development -->
                        <div class="col">
                            <article class="card card-service animation-box anim-normal anim-delay-sm"
                                data-animation="fade-right">
                                <div class="service-card-header">
                                    <div class="service-icon-box">
                                ...
                                <div class="service-card-body">
                                    <h3 class="heading-sm">Mobile App Development</h3>
                                    <p>Engineered native iOS, Android, and cross-platform Flutter/React Native mobile
                                        applications designed for high user engagement.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Flutter & React Native Apps</li>
                                        <li><i class="fa-solid fa-circle-check"></i> Native Swift & Kotlin Engineering
                                        </li>
                                        <li><i class="fa-solid fa-circle-check"></i> Scalable Cloud Backend APIs</li>
                                    </ul>
                                </div>
                                <a href="app-development.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                        ...
                        <div class="col">
                            <article class="card card-service animation-box anim-normal anim-delay-sm"
                                ...
                                <div class="service-card-header">
                                    ...
                                    <span class="service-tag">Social Growth</span>
                                </div>
                                <div class="service-card-body">
                                    <h3 class="heading-sm">Social Media Marketing</h3>
                                    <p>Build explosive brand awareness, viral short-form reel content, and engage
                                        targeted communities across Instagram, TikTok & LinkedIn.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Content Strategy & Reel Creation
                                        </li>
                                        <li><i class="fa-solid fa-circle-check"></i> Influencer & Community Growth</li>
                                        <li><i class="fa-solid fa-circle-check"></i> Paid Social Ad Campaigns</li>
                                    </ul>
                                </div>
                                <a href="social-media-marketing.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                        ...
                        <div class="col">
                            <article class="card card-service animation-box anim-fast anim-delay-none"
                                data-animation="fade-right">
                                <div class="service-card-header">
                                    <div class="service-icon-box">
                                        <i class="fa-solid fa-magnifying-glass-chart"></i>
                                    </div>
                                    <span class="service-tag">Rank #1 Google</span>
                                </div>
                                <div class="service-card-body">
                                    <h3 class="heading-sm">Search Engine Optimization</h3>
                                    <p>Dominate Google search results with technical SEO audits, high-intent keyword
                                        strategies, and high-authority link building.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Technical & On-Page SEO Audits</li>
                                        <li><i class="fa-solid fa-circle-check"></i> High-Intent Keyword Strategy</li>
                                        <li><i class="fa-solid fa-circle-check"></i> High-Authority Backlink Building
                                        </li>
                                    </ul>
                                </div>
                                <a href="search-engine-optimization.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                        ...
                        <div class="col">
                            <article class="card card-service animation-box anim-fast anim-delay-none"
                                ...
                                <div class="service-card-body">
                                    <h3 class="heading-sm">Branding & Creative Design</h3>
                                    <p>Establish a distinctive visual identity with logo design, complete style guides,
                                        motion graphics, and high-impact ad creatives.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Logo & Brand Style Guides</li>
                                        <li><i class="fa-solid fa-circle-check"></i> High-Converting Ad Creatives</li>
                                        <li><i class="fa-solid fa-circle-check"></i> UI/UX & Motion Design</li>
                                    </ul>
                                </div>
                                <a href="branding-creative-design.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                        ...
                        <div class="col">
                            <article class="card card-service animation-box anim-slow anim-delay-md"
                                ...
                                <div class="service-card-header">
                                    ...
                                    <span class="service-tag">Lead Automation</span>
                                </div>
                                <div class="service-card-body">
                                    <h3 class="heading-sm">CRM & Lead Management</h3>
                                    <p>Automate sales pipelines, lead scoring, automated email/WhatsApp follow-ups, and
                                        customer relationship management workflows.</p>
                                    <ul class="service-feature-list">
                                        <li><i class="fa-solid fa-circle-check"></i> Automated Sales Pipelines</li>
                                        <li><i class="fa-solid fa-circle-check"></i> Instant WhatsApp & Email Nurturing
                                        </li>
                                        <li><i class="fa-solid fa-circle-check"></i> Lead Scoring & CRM Tracking</li>
                                    </ul>
                                </div>
                                <a href="crm-lead-management.php" class="btn btn-accent w-100 mt-auto">
                                    <div class="btn-title">
                ...
                <div class="row row-cols-lg-2 row-cols-1 align-items-center px-5 position-relative z-2">
                    <div class="col">
                        <div class="d-flex flex-column justify-content-start pe-lg-3 pe-0">
                            <h3 class="title-heading">Why Choose MARKETENZA? </h3>
                        </div>
                    </div>
                    <div class="col">
                        <div class="d-flex flex-column ps-lg-3 ps-0">
                            <p>
                                Choosing the right virtual marketing companion could make all the distinction. At
                                MARKETENZA, we recognition on strategies that deliver real enterprise effects—no longer
                                simply arrogance metrics. </p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#">
                                        <div class="partner-slide">
                                            <img src="image/1.png" alt="Client" class="partner-logo img-fluid">
                                        </div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                ...
                <div class="chooseus-content-container">
                    <div class="d-flex flex-column gspace-5">
                        ...
                        <div class="image-container">
                            <img src="image/collaborative-process-of-multicultural-skilled-peo-5EHBQRG-1024x683.jpg"
            ...
            <div class="case-studies-layout">
                <div class="card card-case-studies">
                    <div class="row row-cols-lg-2 row-cols-1 grid-spacer-5">
                        <div class="col">
                            <div class="d-flex flex-column gspace-2 animation-box anim-normal anim-delay-sm"
                                data-animation="fade-right">
                                <div class="sub-heading">
                                    <i class="fa-regular fa-circle-dot"></i>
                                    <span>Industries We Serve</span>
                                </div>
                                <h2 class="title-heading">Helping Businesses Across Every Industry Grow Digitally</h2>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex flex-column h-100 justify-content-end gspace-2 animation-box anim-normal anim-delay-sm"
                                data-animation="fade-left">
                                <p>At MARKETENZA, we deliver customized digital marketing answers tailor-made to the
                                    particular dreams of each enterprise. From growing logo consciousness to producing
                                    certified leads and using on-line sales, our records-driven techniques help
                                    companies achieve sustainable increase.
                                </p>
                                <div class="link-wrapper">
                    ...
                    <div class="d-flex flex-column gspace-2">
                        <div class="d-flex flex-column flex-lg-row gspace-2">
                            <div class="card case-studies-content local-business animation-box anim-fast anim-delay-none"
                                data-animation="fade-up">
                                <div
                                ...
                                <div class="d-flex flex-column gspace-2">
                                    <a href="#" class="heading-sm case-studies-title">Healthcare Growth Marketing</a>
                                    <p>
                                        120% increase in patient inquiries through Local SEO, Google Ads, and
                                        healthcare-focused content marketing. </p>
                                </div>
                            </div>
                            <div class="card case-studies-content saas-leads animation-box anim-normal anim-delay-sm"
                                data-animation="fade-up">
                                <div class="d-flex flex-column gspace-2">
                                    <a href="#" class="heading-sm case-studies-title">Real Estate Lead Generation</a>
                                    <p>
                                        3x more qualified property leads with high-converting landing pages and
                                        performance-driven advertising campaigns. </p>
                                </div>
                                <div
                        ...
                        <div class="d-flex flex-column flex-lg-row gspace-2">
                            <div class="card case-studies-content ecommerce animation-box anim-fast anim-delay-none"
                                data-animation="fade-up">
                                <div
                                ...
                                <div class="d-flex flex-column gspace-2">
                                    <a href="#" class="heading-sm case-studies-title">Manufacturing & Industrial</a>
                                    <p>
                                        Expanded global visibility and increased B2B inquiries through SEO and targeted
                                        digital campaigns. </p>
                                </div>
                            </div>
                            <div class="card case-studies-content startup-branding animation-box anim-normal anim-delay-sm"
                                data-animation="fade-up">
                                <div class="d-flex flex-column gspace-2">
                                    <a href="#" class="heading-sm case-studies-title">Local Businesses</a>
                                    <p>
                                        Improved local search rankings and consistent customer inquiries with
                                        hyper-local marketing strategies. </p>
                                </div>
                                <div
            ...
            <div class="d-flex flex-column gspace-5">
                <div class="d-flex flex-column flex-lg-row gspace-5">
                    <div class="testimonial-reviewer-container">
                        <div class="testimonial-header-wrapper animation-box anim-fast anim-delay-none"
                            data-animation="fade-down">
                            <div class="card card-testimonial-reviewer">
                                <div
                                    class="d-flex flex-column flex-md-row flex-lg-column justify-content-between gspace-3">
                                ...
                                <div
                                    class="d-flex flex-column flex-md-row flex-lg-column justify-content-center gspace-2">
                    ...
                    <div class="testimonial-title-container">
                        <div class="testimonial-header-wrapper-title animation-box anim-normal anim-delay-sm"
                            data-animation="fade-left">
                            <div class="card-testimonial-header-title">
                                ...
                                <h2 class="title-heading">Why Digital Marketing Matters</h2>
                                <p>Today's customers seek online before making shopping selections. Without a strong
                                    digital presence, groups pass over precious opportunities to reach capability
                                    clients. Investing in expert virtual advertising facilitates improve brand
                                    cognizance, growth internet site traffic, generate pleasant leads, and force
                                    lengthy-term commercial enterprise boom. At MARKETENZA, we use ethical advertising
                                    practices, superior analytics, and the modern day industry developments to assist
                                    companies live ahead of the opposition.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            <div class="d-flex flex-row gspace-2">
                                                <div class="testimonial-image">
                                                    <img src="image/Photo-13.jpg" alt="Testimonial Image"
                                                        class="img-fluid">
                                                </div>
                                                <div class="d-flex flex-column">
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-testimonial">
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            <div class="d-flex flex-row gspace-2">
                                                <div class="testimonial-image">
                                                    <img src="image/Photo-8.jpg" alt="Testimonial Image"
                                                        class="img-fluid">
                                                </div>
                                                <div class="d-flex flex-column">
                                        ...
                                        <p class="testimonial-description">
                                            “We've worked with many agencies before, but Marko stands out. Their
                                            data-driven approach and creative solutions gave us an edge over
                                            competitors.”
                                        </p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card card-testimonial">
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            <div class="d-flex flex-row gspace-2">
                                                <div class="testimonial-image">
                                                    <img src="image/Photo-11.jpg" alt="Testimonial Image"
                                                        class="img-fluid">
                                                </div>
                                                <div class="d-flex flex-column">
                                        ...
                                        <p class="testimonial-description">
                                            “From SEO to paid ads, Marko nailed every aspect of our campaign. Our
                                            website traffic skyrocketed, and lead generation has never been better!”
                                        </p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card card-testimonial">
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            <div class="d-flex flex-row gspace-2">
                                                <div class="testimonial-image">
                                                    <img src="image/Photo-12.jpg" alt="Testimonial Image"
                                                        class="img-fluid">
                                                </div>
                                                <div class="d-flex flex-column">
            ...
            <div class="hero-container">
                <div class="digital-process-content">
                    <div class="row row-cols-lg-2 row-cols-1 grid-spacer-5">
                        ...
                        <div class="col">
                            <div class="d-flex flex-column gspace-2 justify-content-end h-100 animation-box anim-fast anim-delay-none"
                                data-animation="fade-down">
                                <p>
                                    We drive measurable business growth through strategic digital marketing, SEO,
                                    targeted campaigns, quality leads, and higher conversions. </p>
                                <div class="link-wrapper">
                    ...
                    <div class="digital-process-steps-wrapper">
                        <div class="digital-process-steps">
                            <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
                                <div class="col">
                                    <div class="digital-process-step animation-box anim-normal anim-delay-sm"
                                        data-animation="fade-up">
                                        ...
                                        <div class="d-flex flex-column gspace-2">
                                            ...
                                            <p>
                                                We recognize your business, industry, competition, and audience. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="d-flex flex-md-row flex-column gspace-2 animation-box anim-normal anim-delay-sm"
                                        data-animation="fade-down">
                                        ...
                                        <div class="digital-process-step">
                                            ...
                                            <div class="d-flex flex-column gspace-2">
                                                ...
                                                <p>
                                                    Our specialists create a custom designed virtual marketing roadmap
                                                    aligned together with your targets. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-md-row flex-column gspace-2 animation-box anim-normal anim-delay-sm"
                                        ...
                                        <div class="digital-process-step">
                                            ...
                                            <div class="d-flex flex-column gspace-2">
                                                ...
                                                <p>
                                                    We implement search engine marketing, paid advertising, social
                                                    media, and content material advertising campaigns with precision.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="d-flex flex-md-row flex-column gspace-2 animation-box anim-normal anim-delay-sm"
                                        ...
                                        <div class="digital-process-step">
                                            ...
                                            <div class="d-flex flex-column gspace-2">
                                                <h3 class="heading-xs">Business Growth</h3>
                                                <p>
                                                    Our data-pushed technique facilitates boom internet site traffic,
                                                    leads, sales, and basic go back on funding. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="newsletter-wrapper">
                <div class="newsletter-layout">
                    ...
                    <div class="d-flex flex-column gspace-5 position-relative z-2">
                        ...
                        <form action="https://marko.foxcreation.net/php/newsletter_process.php" method="POST"
                            id="newsletter-form" class="needs-validation animation-box anim-normal anim-delay-sm"
                            data-animation="fade-left">
    ...
    <div class="faq-container">
        ...
        <div class="faq-item">
            <button class="faq-question">
                <span>What are SEO services?</span>
                <i class="fa-solid fa-plus"></i>
            </button>

            <div class="faq-answer">
                <p>
                    SEO services help improve your website's visibility on search engines like Google through keyword optimization, content marketing, technical SEO, and link building.
                </p>
            </div>
        </div>
        ...
        <div class="faq-item active">
            <button class="faq-question">
                <span>Why does a business need SEO services?</span>
                <i class="fa-solid fa-xmark"></i>
            </button>
            <div class="faq-answer">
                <p>
                    SEO services are essential for businesses to
                    <a href="#">build brand presence</a>,
                    increase their online visibility,
                    attract more potential customers,
                    and stay ahead of the competition in the digital marketplace.
                </p>
                <p>
                    Businesses wanting to increase their website traffic,
                    conversions, and ROI need SEO services.
                </p>
            </div>
        </div>
        ...
        <div class="faq-item">
            <button class="faq-question">
                <span>How does Techmagnate determine the right SEO strategy for a business?</span>
                <i class="fa-solid fa-plus"></i>
            </button>
            <div class="faq-answer">
                <p>
                    We analyze your industry, competitors, keywords, audience, and business goals to create a custom SEO strategy.
                </p>
            </div>
        </div>
        ...
        <div class="faq-item">
            <button class="faq-question">
                <span>What types of SEO Services does Techmagnate offer?</span>
                <i class="fa-solid fa-plus"></i>
            </button>
            <div class="faq-answer">
                <p>
                    We provide Local SEO, Enterprise SEO, E-commerce SEO, Technical SEO, International SEO, and Content Marketing services.
                </p>
            </div>
        </div>
        ...
        <div class="hero-container">
            <div class="row row-cols-lg-2 row-cols-1 grid-spacer-5">
                ...
                <div class="col col-lg-7">
                    <div class="accordion" id="faqAccordionSmm">
